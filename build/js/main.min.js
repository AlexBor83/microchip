...
/* harmony import */ var _modules_phone_mask_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/phone-mask.js */ "./js/modules/phone-mask.js");
...
/* harmony import */ var _modules_validate_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/validate.js */ "./js/modules/validate.js");
/* harmony import */ var _modules_scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scroll.js */ "./js/modules/scroll.js");




Object(_modules_phone_mask_js__WEBPACK_IMPORTED_MODULE_0__["initPhoneMask"])();
Object(_modules_modal_js__WEBPACK_IMPORTED_MODULE_1__["togglerModal"])();
Object(_modules_menu_js__WEBPACK_IMPORTED_MODULE_2__["clouseFooterMenu"])();
Object(_modules_menu_js__WEBPACK_IMPORTED_MODULE_2__["togglerFooterMenu"])();
Object(_modules_validate_js__WEBPACK_IMPORTED_MODULE_3__["saveLocalStorage"])();

Object(_modules_scroll_js__WEBPACK_IMPORTED_MODULE_4__["initInnerLinks"])(); //
//
...
/*!****************************!*\
  !*** ./js/modules/menu.js ***!
  \****************************/
/*! exports provided: clouseFooterMenu, togglerFooterMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clouseFooterMenu", function() { return clouseFooterMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "togglerFooterMenu", function() { return togglerFooterMenu; });
var footerButtons = document.querySelectorAll('.footer__button');
var footerSection = document.querySelectorAll('.footer__section');
var footerLists = document.querySelectorAll('.footer__list');

var showFooterMenuItem = function showFooterMenuItem(i) {
...
var clouseFooterMenuItem = function clouseFooterMenuItem(i) {
...
var clouseFooterMenu = function clouseFooterMenu() {
  footerLists.forEach(function (i) {
    i.classList.add('close-menu');
    i.classList.remove('open-menu');
  });
  footerButtons.forEach(function (i) {
    i.classList.add('footer__button--clouse');
  });
};

var togglerFooterMenu = function togglerFooterMenu() {
  if (!footerSection) {
    return;
  }

  footerButtons.forEach(function (item, number) {
...
/*!*****************************!*\
  !*** ./js/modules/modal.js ***!
  \*****************************/
/*! exports provided: togglerModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "togglerModal", function() { return togglerModal; });
// import {loadLocalStorage} from './validate.js';
var buttonOpendForm = document.querySelector('.header__button');
var modal = document.querySelector('.modal');
var body = document.querySelector('body');
var buttonClosedForm = document.querySelector('.form__button--modal');
var modalLogin = modal.querySelector('.login'); // const form = modal.querySelector('form');

var closedModal = function closedModal() {
...
var openModal = function openModal() {
  ...
  modalLogin.focus(); // loadLocalStorage(); если включаю то отключается маска телефона

  body.classList.add('fixed-page');
};

var togglerModal = function togglerModal() {
  if (!modal) {
    return;
  }

  buttonOpendForm.addEventListener('click', function () {
  ...
  buttonClosedForm.addEventListener('click', function () {
    closedModal();
  });
};
...
/*!******************************!*\
  !*** ./js/modules/scroll.js ***!
  \******************************/
/*! exports provided: initInnerLinks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInnerLinks", function() { return initInnerLinks; });
...
var move = new _vendor_move_to__WEBPACK_IMPORTED_MODULE_0___default.a({
  duration: 1000,
  easing: 'easeOutQuart'
});

var initInnerLinks = function initInnerLinks() {
...
/*!********************************!*\
  !*** ./js/modules/validate.js ***!
  \********************************/
/*! exports provided: saveLocalStorage, loadLocalStorage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveLocalStorage", function() { return saveLocalStorage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadLocalStorage", function() { return loadLocalStorage; });
var modal = document.querySelector('.form--modal');
var form = modal.querySelector('form');
var inputText = form.querySelector('input[type="text"]');
var inputTel = form.querySelector('input[type="tel"]');
var inputTextarea = form.querySelector('textarea');
